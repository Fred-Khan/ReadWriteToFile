# This code will check for the string "You've been hacked!" and, if found, append "This file is no good!" at the end of the file. 
...
try:
    ...
    with open(file_location, 'r') as file:
        ...
        if "You've been hacked!" in file_contents:
            ...
            # Append the string "This file is no good!" at the end of the file
